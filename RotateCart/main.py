...
# ---------------------------------------------------------------------------- #
# Rotation en coordonnées Cartésiennes d'une image 256 niveaux de gris (8 bits par pixel) par fonction perso de functionlib.py
...
Jtab = RotateCart(Itab, angle_deg, x0, y0)  # fonction perso de functionlib.py : rotation d'image 256 niveaux gris (8 bits par pixel)
...
J.save('rotate.jpg')  # PIL : enregistrement image traitee
K.save('coco+rotate.jpg')  # PIL : enregistrement images initiale/traitee empilees
